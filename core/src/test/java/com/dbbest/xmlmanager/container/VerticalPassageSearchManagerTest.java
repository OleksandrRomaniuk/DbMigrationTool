...
public class VerticalPassageSearchManagerTest {
    ...
    public void shouldFindNameInContainers() {
        ...
        List<Container> listActual = verticalPassageSearchManager.searchInNames("child6");
    ...
    public void shouldFindValueInContainers() {
        VerticalPassageSearchManager verticalPassageSearchManager = new VerticalPassageSearchManager(container);
        List<Container> listActual = verticalPassageSearchManager.searchInValues("child1");
        DbList<Container> listExpected = new ListOfChildren();
