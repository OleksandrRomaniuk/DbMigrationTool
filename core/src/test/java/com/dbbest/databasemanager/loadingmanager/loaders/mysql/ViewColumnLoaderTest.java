...
public class ViewColumnLoaderTest {
    ...
    public void shouldExecuteDetailLoadOfViewColumns() throws SQLException, DatabaseException, ContainerException {
        ...
        PreparedStatement preparedStatement = mock(PreparedStatement.class);
        String query = "SELECT TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME, ORDINAL_POSITION, IS_NULLABLE, DATA_TYPE, CHARACTER_MAXIMUM_LENGTH, CHARACTER_OCTET_LENGTH, NUMERIC_PRECISION, NUMERIC_SCALE, DATETIME_PRECISION, CHARACTER_SET_NAME, COLUMN_TYPE, PRIVILEGES, EXTRA, COLUMN_COMMENT, GENERATION_EXPRESSION, COLUMN_DEFAULT, COLUMN_KEY, COLLATION_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA= 'sakila' AND TABLE_NAME = 'testTable' AND  COLUMN_NAME = 'null' ;";
