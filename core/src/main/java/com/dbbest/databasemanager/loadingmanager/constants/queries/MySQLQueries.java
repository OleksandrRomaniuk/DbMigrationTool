...
public class MySQLQueries {
    ...
    private final String tableDetailed = "SELECT %s FROM INFORMATION_SCHEMA.TABLES WHERE table_schema = '%s' AND table_name = '%s' ;";
    private final String functionLazy = "SELECT SPECIFIC_NAME  FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = '%s' AND ROUTINE_TYPE = 'FUNCTION' ;";
