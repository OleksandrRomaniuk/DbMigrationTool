...
import com.dbbest.services.TreeBuilder;
...
public class LoadController {
    ...
    private Container getTestTree(@RequestBody LoadQueryWrapper loadQueryWrapper,
            ...
            throws DatabaseException, ContainerException {
    ...
    private Container checkTree(@RequestBody LoadQueryWrapper loadQueryWrapper,
                                HttpServletRequest request, HttpServletResponse response) throws ContainerException, DatabaseException {
